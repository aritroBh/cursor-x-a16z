...
function renderEyes(mood: SpecMood) {
    ...
    return (
      <>
        <path
          ...
          d="M27 27l1.6 3.8 4.2.3-3.1 2.7 1 4-3.7-2.1-3.7 2.1 1-4-3.1-2.7 4.2-.3z"
        />
        <path
          className="spec-buddy__star-eye"
          d="M46 27l1.6 3.8 4.2.3-3.1 2.7 1 4-3.7-2.1-3.7 2.1 1-4-3.1-2.7 4.2-.3z"
        />
  ...
  if (mood === "judging") {
    return (
      <>
        <path
          className="spec-buddy__eye-line judging"
          d="M21 31c5-2 10-1 14 2"
        />
        <path
          className="spec-buddy__eye-line judging"
          d="M40 32c5-2 10-2 14-1"
        />
              ...
              {mood === "judging" && (
                <>
                  <path
                    ...
                    d="M21 40c8 5 20 6 31 1"
                  />
                  <path
                    className="spec-buddy__arm-cross"
                    d="M51 38c-9 7-20 9-31 5"
                  />
                </>
              )}
            </g>
