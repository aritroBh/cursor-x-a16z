  ...
  return (
    <div className="session-panel" style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px' }}>
            Goal
          </div>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <div style={{ fontSize: '13px', fontWeight: 600, color: 'rgba(255,255,255,0.8)', marginTop: '2px' }}>
            {appName || 'Unknown'}
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: isWalkthroughActive ? '#30d158' : 'rgba(255,255,255,0.3)' }} />
      ...
      {isWalkthroughActive && (
        <div className="progress-bar-container" style={{ marginTop: '4px' }}>
          <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.3)', fontWeight: 700, marginBottom: '6px', textAlign: 'center' }}>
            Step Progress
          </div>
